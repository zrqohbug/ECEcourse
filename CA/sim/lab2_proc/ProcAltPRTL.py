...
from ProcAltDpathPRTL   import ProcAltDpathPRTL
from ProcAltCtrlPRTL    import ProcAltCtrlPRTL
...
class ProcAltPRTL( Model ):
  ...
  def __init__( s, num_cores = 1 ):
    ...
    s.ctrl  = ProcAltCtrlPRTL()
    s.dpath = ProcAltDpathPRTL( num_cores )
    ...
    s.connect_pairs(
      ...
      s.ctrl.dmemreq_type,  s.dmemreq_queue.enq.msg.type_,   
      s.ctrl.dmemreq_opaque,s.dmemreq_queue.enq.msg.opaque,
      s.ctrl.dmemreq_len,   s.dmemreq_queue.enq.msg.len,
