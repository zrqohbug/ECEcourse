  ...
  def __init__( s ):
    ...
    def comb_PC_sel_F():
      if s.pc_redirect_X:
        ...
        s.pc_sel_F.value = 2 # use jal
      elif s.pc_redirect_X_J:
        s.pc_sel_F.value = 3 # use jalr
      else:
    ...
    def comb_control_table_D():
      ...
      elif inst == JALR : cs( y, br_jalr,imm_i, y, op_rf, bm_imm, n, alu_add, ex_p,  nr, wm_a, y,  n,   n    )
    ...
    @s.combinational
    def comb_br_D():
      if s.val_D and ( s.br_type_D == br_jal ):
    ...
    def comb_br_X():
      if s.val_X and ( s.br_type_X == br_bne ):
        ...
        s.pc_redirect_X_J.value = 1
      else:
        s.pc_redirect_X.value = 0
        s.pc_redirect_X_J.value = 0
    ...
    def comb_X():
      ...
      s.osquash_X.value   = s.val_X & ~s.stall_X & (s.pc_redirect_X | s.pc_redirect_X_J)
