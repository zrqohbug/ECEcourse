...
def gen_src_dep_test():
  return [
    ...
    gen_rimm_src_dep_test( 2, "sltiu", 0x0000f0f0, 0xf0f, 0x00000001 ),
...
def gen_srcs_dest_test():
  return [
    gen_rimm_src_eq_dest_test( "sltiu", 0x00000f0f, 0xff0, 0x00000001 ),
  ]
...
def gen_random_test():
  ...
  for i in xrange(100):
    ...
    dest = Bits( 32, 1 ) if src < sext( imm, 32 ) else Bits( 32, 0 )
